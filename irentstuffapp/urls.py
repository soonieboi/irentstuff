...
urlpatterns = [
    ...
    path('stuff/<int:item_id>/add_purchase/', views.add_purchase, name='add_purchase'),
    path('stuff/<int:item_id>/add_purchase/<str:username>', views.add_purchase, name='add_purchase'),
    path('stuff/<int:item_id>/accept_purchase/', views.accept_purchase, name='accept_purchase'),
    path('stuff/<int:item_id>/complete_purchase/', views.complete_purchase, name='complete_purchase'),
    path('stuff/<int:item_id>/cancel_purchase/', views.cancel_purchase, name='cancel_purchase'),
    ...
    path('reset_password_sent', auth_views.PasswordResetDoneView.as_view(template_name='irentstuffapp/password_reset_done.html'),
         name="password_reset_done"),
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='irentstuffapp/password_reset_confirm.html'),
         name="password_reset_confirm"),
    path('reset_password_complete', auth_views.PasswordResetCompleteView.as_view(template_name='irentstuffapp/password_reset_complete.html'),
